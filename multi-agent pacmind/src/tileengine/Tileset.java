...
public class Tileset {
    ...
    public static TETile AVATAR = new TETile('@', Color.white, Color.black, "you","none",0);

    public static void update_avatar(String avatar_name) {
        Tileset.AVATAR.filepath = avatar_name;
        System.out.println("filepath updated");
    }


    public static final TETile WALL = new TETile('#', new Color(216, 128, 128), Color.black,
            "wall", "./images/wall_blank.png",1);
    public static final TETile FLOOR = new TETile('·', new Color(128, 192, 128), Color.black, "floor", 2);
    public static final TETile NOTHING = new TETile(' ', Color.black, Color.black, "nothing", "./images/wall_behind.png",  3);
    ...
    public static final TETile FLOWER = new TETile('❀', Color.magenta, Color.pink, "flower", "./images/coin.png", 6);
